...
int findroot_Newton_added(double x1, double x2, double* rts, double xacc,
...
double findroot_Ridder_added(double x1, double x2, double xacc,
	double(*func)(Project* project, double, void* p), void* p, Project* project)
{
	int j;
	double ans, fhi, flo, fm, fnew, s, xhi, xlo, xm, xnew;
